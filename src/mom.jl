...
"""
function kst(x::AbstractArray{T}; nroc::AbstractArray{Int64} = [10, 15, 20, 30],
    navg::AbstractArray{Int64} = [10, 10, 10, 15],
    wgts::AbstractArray{Int64} = collect(1:length(nroc)), ma::Function = sma,
)::Array{Float64} where {T<:Real}
...
"""
function smi(hlc::AbstractMatrix{T}; n::Int64 = 13, nFast::Int64 = 2, nSlow::Int64 = 25,
    nSig::Int64 = 9,
